...
const Waitlist = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userDocRef = doc(waitlistCollection, validated.email);
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto">
            Be among the first to experience the future of interpretation
            technology. Get exclusive early access to InterpreLab's AI-powered
            platform.
          </p>
