...
// Gold, beige, cream color scheme for VRI and OPI
const COLORS = {
  vri: '#D4AF37', // Rich gold
  opi: '#C9A961', // Lighter gold/beige
};
    ...
    <Card className="h-full flex flex-col border-border/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
      <CardHeader className="pb-4">
        <CardTitle className="flex items-center gap-2">
          <div className="w-2 h-6 bg-gradient-to-b from-nobel-gold to-amber-600 rounded-full" />
          Call Type Breakdown
        </CardTitle>
        <CardDescription>
      ...
      <CardContent className="flex-grow flex flex-col items-center justify-center pb-6">
        {totalCalls > 0 ? (
          <div className="w-full">
            {/* Pie Chart */}
            <div className="w-full max-w-[300px] mx-auto h-[300px]">
            ...
            {/* Total Summary */}
            <div className="mt-6 p-4 rounded-lg bg-gradient-to-br from-nobel-gold/10 to-amber-600/10 border border-nobel-gold/30">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-muted-foreground">Total Calls</span>
                <span className="text-2xl font-bold bg-gradient-to-r from-nobel-gold to-amber-600 bg-clip-text text-transparent">
                  {totalCalls}
                </span>
              </div>
            </div>
